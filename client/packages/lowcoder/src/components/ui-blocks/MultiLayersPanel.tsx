...
export const MultiLayersPanel: any = ({ items, filters }: any) => {
  return (
    <MultiLayersPanelRoot>
      {filters && <MultiLayersPanelScope filters={filters} />}
...
export const MultiLayersPanelScope = ({ filters }) => {
  ...
  return (
    ...
    >
      <Combobox.Root flex={1} collection={collection} onInputValueChange={(e) => filter(e.inputValue)} openOnClick>
...
export const MultiLayersPanelSection = ({ section }) => {
  return (
    <Accordion.Item key={section.value} value={section.value} asChild>
